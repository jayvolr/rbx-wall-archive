...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"linkify.min.js":[function(require,module,exports) {
...
!function () {
  ...
  !function (e) {
    ...
    function t(n) {
      ...
      for (var e = n.hasOwnProperty("ignoreTags") ? n.ignoreTags : h.ignoreTags, a = 0; a < e.length; a++) {
        this.ignoreTags.push(e[a].toUpperCase());
      }
    }
    ...
    function c(n, e, a, t) {
      ...
      for (; o < r - 1;) {
        c = new m(t), s.push(c), i.on(n[o], c), i = c, o++;
      }
    ...
    t.prototype = {
      ...
      getObject: function getObject(n, e, a) {
        var t = this[n];
    ...
    for (var xn = 0; xn < F.length; xn++) {
      F[xn].on("-", en).on(X, nn);
    }

    en.on("-", en).on(W, nn).on(X, nn), V.defaultTransition = J(E);

    var yn = function yn(n) {
      for (var e = n.replace(/[A-Z]/g, function (n) {
        return n.toLowerCase();
      }), a = n.length, t = [], o = 0; o < a;) {
        for (var r = V, i = null, s = 0, c = null, l = -1; o < a && (i = r.next(e[o]));) {
          r = i, r.accepts() ? (l = 0, c = r) : l >= 0 && l++, s++, o++;
        }
    ...
    var jn = a(wn, l(), {
      ...
      isLink: !0,
      toHref: function toHref() {
        for (var n = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "http", e = !1, a = !1, t = this.v, o = [], r = 0; t[r] instanceof S;) {
          e = !0, o.push(t[r].toString().toLowerCase()), r++;
        }

        for (; t[r] instanceof L;) {
          a = !0, o.push(t[r].toString()), r++;
        }

        for (; g(t[r]);) {
          o.push(t[r].toString().toLowerCase()), r++;
        }
    ...
    var pe = function pe(n) {
      for (var e = n.length, a = 0, t = [], o = []; a < e;) {
        for (var r = An, i = null, s = null, c = 0, l = null, u = -1; a < e && !(i = r.next(n[a]));) {
          o.push(n[a++]);
        }

        for (; a < e && (s = i || r.next(n[a]));) {
          i = null, r = s, r.accepts() ? (u = 0, l = r) : u >= 0 && u++, a++, c++;
        }

        if (u < 0) for (var g = a - c; g < a; g++) {
          o.push(n[g]);
        } else {
...
},{}]},{},["../../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","linkify.min.js"], null)
//# sourceMappingURL=/linkify.min.89d9a54e.map